...
# Ligar o uvicorn
# python -m uvicorn mark01:app --reload
...
def pedir_para_ser_coordenador():
    ...
    pedidoMarket01 = requests.post("localhost:8080/eleicao/marketplace01") 
    pedidoMarket02 = requests.post("localhost:8080/eleicao/marketplace01")
    pedidoMarket03 = requests.post("localhost:8080/eleicao/marketplace01")
    ...
    if aprovacoes >= 1.5:
        ...
        #Mandar mensagem para os 3 marketplaces com o padrão 
            ...
            # "/eleicao/marketplace02"
            # "/eleicao/marketplace03"
        requests.post("localhost:8080/coordenador/eleito/marketplace01") #Market01
        requests.post("localhost:8080/coordenador/eleito/marketplace02") #Market02
...
def verificar_coordenador_online():
    #Mandar mensagem para o coordenador
        # "/eleicao/{coordenador}"
    coordenadorOnline = requests.get("localhost:8080/coordenador/online")
